...
// Social Icons
function SocialIconBase({ href, children }: SocialIconBaseProps) {
  return (
    <a rel="noopener nofollow noreferrer external" target="_blank" href={href}>
      <svg
...
function InstagramIcon() {
  return (
    <SocialIconBase href="https://www.instagram.com/americantravelconsulting/">
...
function FacebookIcon() {
  return (
    <SocialIconBase href="https://www.facebook.com/AmericanTravelConsulting/">
